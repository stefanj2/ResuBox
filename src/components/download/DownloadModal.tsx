            ...
            <div className="mb-6">
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <span className="text-sm text-slate-700 leading-relaxed">
                  ...
                  . Ik begrijp dat voor het downloaden van mijn CV een vergoeding van tweeënveertig euro in rekening wordt gebracht en dat het CV naar mijn e-mailadres wordt gestuurd.
                </span>
              </label>
            </div>
